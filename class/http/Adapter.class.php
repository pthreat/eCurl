<?php
	...
	namespace apf\http{
		...
		use apf\core\Adapter			as CoreAdapter;
		use apf\iface\http\Adapter	as	HttpAdapterInterface;

		abstract class Adapter extends CoreAdapter implements HttpAdapterInterface{
